...
def plot_inf_curve(plt2, N, mean, alpha, m, y, equilibria, final = [], save=0, ys=[], opaque=0.35):
    ...
    plt2.set_xlabel("Observed average rating", fontsize=14)
...
def plot_avg(ax, N, sims, true_mean, equilibria, save=0):
    ...
    Args:
        ...
        avg (list): List of observed averages.
    ...
    ax.set_ylabel("Observed average rating", fontsize=14)
    ...
    if len(sims) != 1:
        ...
        cbar.set_label("Final average rating", fontsize=12)
